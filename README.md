...
, which contains 398 entries of various car models from 1970 to 1982.
...
300 estimators, learning rate 0.05, max_depth 4
...
The XGBoost model performs slightly better in terms of RMSE and R².
